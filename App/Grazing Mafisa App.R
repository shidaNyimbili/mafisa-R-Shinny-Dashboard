...
communities1 <- st_read("App/Cohort01_CommunityBoundaries.gpkg")
communities2 <- st_read("App/Cohort2_CommunityBoundaries.gpkg")

blocks1 <- st_read("App/20251014Cohort01OverlapCorrection.shp")
blocks2 <- st_read("App/20251014Cohort2OverlapCorrection.shp")

blocks1_elig <- st_read("App/20251014Cohort01OverlapCorrection_eligible.gpkg")
blocks2_elig <- st_read("App/20251014Cohort2OverlapCorrection_eligible.gpkg")

PAI_boundaries <- st_read("App/PAI_ClusterBoundaries.gpkg")

project_boundary <- st_read("App/VCS4915_Outer Boundary.shp")


reports24 <- read.csv("App/Master Grazing Reports 2024-April 2025_corrected.csv")
reports25 <- read.csv("App/Grazing Coordinates and Data_2025_10_14.csv")

boreholes <- read.csv("App/Borehole data 2024_and2025.csv")
UNZA_points <- read.csv("App/UNZA 2025 Phase 1 data.csv")

presample_points <- read.csv("App/Pre-sampling data_processed.csv")
